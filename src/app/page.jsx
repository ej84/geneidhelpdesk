  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <div className="relative flex flex-col space-y-5 text-center">
        <h1 className="text-4xl">GeneID HelpDesk</h1>
        <div>
          {isLoggedIn ? (
        ...
        <div className="flex px-20 rounded-md bg-white">
          <FontAwesomeIcon icon={faSearch} className="w-4 mr-5 mt-4" />
          <input
            className="w-auto h-auto outline-none ml-5"
            type="text"
